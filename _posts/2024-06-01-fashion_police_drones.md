...
<div id="try-me-section" style="margin-top: 3rem; padding: 2rem; background: rgba(0,240,255,0.03); border: 1px solid rgba(0,240,255,0.2);">

<h2 style="text-align:center;">TRY ME: Are You a Fashion Criminal?</h2>

<p style="text-align:center; color: #b8a8d8; font-size: 0.85rem;">Upload a photo of yourself (make sure your face is visible — it's important for the scan).<br><span style="font-size: 0.75rem; opacity: 0.7;">Don't worry — your images won't be saved or held as evidence.</span></p>

<div style="text-align:center; margin: 1.5rem 0;">
  <label for="suspect-upload" style="display:inline-block; background:#000; border:2px solid #00f0ff; color:#00f0ff; font-family:'JetBrains Mono',monospace; font-size:0.85rem; letter-spacing:0.1em; text-transform:uppercase; padding:0.75rem 1.5rem; cursor:pointer;">[ Upload Suspect Photo ]</label>
  <input type="file" id="suspect-upload" accept="image/*" style="display:none;">
</div>

<!-- Scan area -->
<div id="scan-area" style="display:none; max-width: 600px; margin: 0 auto;">
  <!-- Uploaded image -->
  <div style="position:relative; text-align:center;">
    <img id="suspect-img" style="max-width:100%; max-height:400px; border: 2px solid #00f0ff; display:block; margin:0 auto;">
  ...
  <!-- Status log -->
  <div id="scan-log" style="margin-top:1rem; font-family:'JetBrains Mono',monospace; font-size:0.7rem; color:#00f0ff; line-height:2; min-height: 200px; background:rgba(0,0,0,0.5); padding:1rem; border:1px solid rgba(0,240,255,0.15);"></div>

  <!-- Results -->
  <div id="scan-results" style="display:none;">
    <!-- Face comparison grid -->
    <div id="comparison-grid" style="margin-top: 1.5rem;">
      <p style="font-size: 0.75rem; color: #b8a8d8; text-transform: uppercase; letter-spacing:0.1em; margin-bottom: 1rem; text-align:center;">Cross-referencing against known fashion criminals...</p>
      <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(100px, 1fr)); gap:0.75rem; max-width:550px; margin:0 auto;">
        <div class="criminal-card" style="text-align:center;">
          ...
          <div style="font-size:0.6rem; color:#ff10f0; margin-top:0.3rem;">SHEIN</div>
          <div style="font-size:0.55rem; color:#b8a8d8;">NO MATCH</div>
        </div>
        <div class="criminal-card" style="text-align:center;">
          ...
          <div style="font-size:0.6rem; color:#ff10f0; margin-top:0.3rem;">ZARA</div>
          <div style="font-size:0.55rem; color:#b8a8d8;">NO MATCH</div>
        </div>
        <div class="criminal-card" style="text-align:center;">
          ...
          <div style="font-size:0.6rem; color:#ff10f0; margin-top:0.3rem;">H&M</div>
          <div style="font-size:0.55rem; color:#b8a8d8;">NO MATCH</div>
        </div>
        <div class="criminal-card" style="text-align:center;">
          ...
          <div style="font-size:0.6rem; color:#ff10f0; margin-top:0.3rem;">NIKE</div>
          <div style="font-size:0.55rem; color:#b8a8d8;">NO MATCH</div>
        </div>
        <div class="criminal-card" style="text-align:center;">
          ...
          <div style="font-size:0.6rem; color:#ff10f0; margin-top:0.3rem;">ADIDAS</div>
          <div style="font-size:0.55rem; color:#b8a8d8;">NO MATCH</div>
        </div>
      </div>
    </div>
    ...
    <!-- Verdict -->
    <div id="verdict" style="margin-top: 2rem; text-align:center; padding: 2rem; border: 2px solid #00f0ff; background: rgba(0,240,255,0.05);">
      <div style="font-size: 0.7rem; color: #b8a8d8; text-transform: uppercase; letter-spacing: 0.15em; margin-bottom: 0.5rem;">Verdict</div>
      <div style="font-size: clamp(2rem, 5vw, 3.5rem); color: #00f0ff; text-shadow: 0 0 20px rgba(0,240,255,0.6); font-weight: 700; letter-spacing: 0.1em;">INNOCENT</div>
      <p style="color: #b8a8d8; font-size: 0.8rem; margin-top: 1rem;">No match found in the Fashion Criminal Database.<br>You're free to go... <em>for now.</em></p>
      <p style="color: #ff10f0; font-size: 0.85rem; margin-top: 1.5rem; font-weight: 700;">We're only looking for the <em>real</em> fashion criminals.</p>
    </div>

    <!-- Environmental Impact Info -->
    <div style="margin-top: 2.5rem; padding: 1.5rem; border-left: 3px solid #ff10f0; background: rgba(255,16,240,0.03);">
      <h3 style="color: #ff10f0; font-size: 1rem; margin-bottom: 1rem;">The Real Fashion Criminals</h3>
      <p style="font-size: 0.8rem;">Shein is currently identified as the largest polluter in the fast fashion industry, with emissions nearly doubling in 2023 due to rapid, AI-driven production. Other top polluting brands include Zara, H&M, Nike, and Adidas. The industry is responsible for 8–10% of global carbon emissions, primarily driven by synthetic fiber production and coal-powered manufacturing in China, Bangladesh, and India.</p>

      <h4 style="color: #00f0ff; font-size: 0.85rem; margin-top: 1.5rem;">Key Polluters and Environmental Impact</h4>
      <ul style="font-size: 0.75rem; color: #b8a8d8; line-height: 2;">
      ...
      <h4 style="color: #00f0ff; font-size: 0.85rem; margin-top: 1.5rem;">Factors Driving Pollution</h4>
      <ul style="font-size: 0.75rem; color: #b8a8d8; line-height: 2;">
      ...
      <h4 style="color: #00f0ff; font-size: 0.85rem; margin-top: 1.5rem;">References</h4>
      <ul style="font-size: 0.65rem; color: #b8a8d8; line-height: 2; word-break: break-all;">
...
(function() {
  ...
  upload.addEventListener('change', async function(e) {
    ...
    // Animate scan line over the image

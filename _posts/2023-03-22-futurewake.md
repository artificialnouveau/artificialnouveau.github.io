...
<figure>
  <img class="img-fluid rounded-left rounded-right shadow-sm" src="../../../assets/portfolio/deepfake1.jpg" alt="Future Wake Face 1" style="max-height: 400px; width: auto; max-width: 100%; height: auto; margin: 2rem auto;">
  <figcaption class="mt-2 text-center image-caption">Image: Future Wake Face 1</figcaption>
</figure>

<figure>
  <img class="img-fluid rounded-left rounded-right shadow-sm" src="../../../assets/portfolio/deepfake2.jpg" alt="Future Wake Face 2" style="max-height: 400px; width: auto; max-width: 100%; height: auto; margin: 2rem auto;">
